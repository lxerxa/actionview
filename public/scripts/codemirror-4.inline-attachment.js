...
(function(document, window) {
  ...
  var inlineAttachment2 = function(options, instance) {
    this.settings = inlineAttachment2.util.merge(options, inlineAttachment2.defaults);
   ...
   * @type {Object}
   */
  inlineAttachment2.editors = {};

  /**
   * Utility functions
   */
  inlineAttachment2.util = {
   ...
   */
  inlineAttachment2.prototype.uploadFile = function(file) {
    var me = this,
   ...
   */
  inlineAttachment2.prototype.isFileAllowed = function(file) {
   ...
   * @return {Void}
   */
  inlineAttachment2.prototype.onFileUploadResponse = function(xhr) {
   ...
   * @return {Void}
   */
  inlineAttachment2.prototype.onFileUploadError = function(xhr) {
   ...
   * @return {Void}
   */
  inlineAttachment2.prototype.onFileInserted = function(file) {
   ...
   */
  inlineAttachment2.prototype.onPaste = function(e) {
    var result = false,
   ...
   * @return {Boolean} if the event was handled
   */
  inlineAttachment2.prototype.onDrop = function(e) {
    var result = false;
  ...
  window.inlineAttachment2 = inlineAttachment2;

})(document, window);

/*jslint newcap: true */
/*global inlineAttachment2: false */
/**
 * CodeMirror version for inlineAttachment2
 *
 * Call inlineAttachment2.attach(editor) to attach to a codemirror instance
 */
(function() {
  'use strict';
  ...
  /**
   * Attach inlineAttachment2 to CodeMirror
   *
  ...
  codeMirrorEditor.attach = function(codeMirror, options) {
    ...
    var editor = new codeMirrorEditor(codeMirror),
      inlineattach = new inlineAttachment2(options, editor),
  ...
  inlineAttachment2.editors.codemirror4 = codeMirrorEditor4;
